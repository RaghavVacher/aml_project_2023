#This script holds all necessary function that we use for the analysis of our models. 
#Please note that it contains local paths
...
#based on standard PyTorch recommendation
