...
for subj in subjects:
    ...
    fmri_dir = os.path.join(subj_path, 'training_fmri')
    lh_fmri = np.load(os.path.join(fmri_dir, 'lh_train_fmri.npy'))
    rh_fmri = np.load(os.path.join(fmri_dir, 'rh_train_fmri.npy'))
